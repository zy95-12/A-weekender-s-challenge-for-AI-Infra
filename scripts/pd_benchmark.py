"""Same sustained C16 cohort/SLO as prior experiments, with full token timings."""
import argparse
import asyncio
import json
import time
...
async def measure(args):
    ...
    rows=[];counts=[0]*args.concurrency;stop=False
    async with httpx.AsyncClient(base_url='http://127.0.0.1:8000',timeout=180,trust_env=False,
        ...
        report['slo_pass']=report['slo_attainment']>=.99
