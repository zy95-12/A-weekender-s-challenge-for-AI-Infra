...
class DemoTest(unittest.TestCase):
    def test_page_contains_all_six_sections_and_evidence_links(self) -> None:
        ...
        self.assertIn("题目中的 AI Infra 小组方案", page)
        self.assertIn("企业 2 卡 · 云端 8 卡", page)
        self.assertIn("8192 × 5120 × dtype", page)
        ...
        self.assertIn('id="optimization-curves"', page)
        self.assertIn("Baseline vs Stage 1+2+3", page)
        self.assertIn("curves.csv", joined)
